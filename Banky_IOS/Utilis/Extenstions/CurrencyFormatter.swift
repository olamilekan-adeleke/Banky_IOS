...
struct CurrencyFormatter {
    ...
    private func makeBalanceAttributed(dollars: String, cents: String) -> NSMutableAttributedString {
        let dollarSignAttributes: [NSAttributedString.Key: Any] = [.font: UIFont.preferredFont(forTextStyle: .caption2), .baselineOffset: 8]
        ...
        let rootString = NSMutableAttributedString(string: "\u{20A6}", attributes: dollarSignAttributes)
